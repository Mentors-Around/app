...
export const PLATFORM_FEE = Object.freeze({
  ...
  PLATFORM_CUT_TOTAL:           10,
  CASE1_MID_TEACHER_PERCENT:    40,
  CASE1_FINAL_TEACHER_PERCENT:  54,
  CASE1_EARLY_LEAVE_TEACHER:    40,
  CASE1_EARLY_LEAVE_STUDENT:    50,
  CASE1_EARLY_LEAVE_PLATFORM:   14,
  CASE2_FINAL_TEACHER_PERCENT:  94,
});