    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-brand-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl animate-expand-in">
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-slate-200">
          <h3 className="font-sora text-base sm:text-lg font-bold text-navy">{title}</h3>
        ...
        {footer && <div className="p-4 sm:p-6 pt-0 flex gap-3 justify-end flex-wrap sm:flex-nowrap">{footer}</div>}
      </div>
    </div>
  );
};
