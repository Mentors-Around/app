...
export const WalletProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (savedTeacher) {
      ...
      localStorage.setItem('trueed_teacher_wallet_data', JSON.stringify({ balance: 0, totalEarnings: 0, totalWithdrawn: 0, transactions: [] }));
    }
    ...
    if (savedStudent) {
      ...
      localStorage.setItem('trueed_student_wallet_data', JSON.stringify({ balance: 0, transactions: [] }));
    }
    ...
    if (savedBanks) {
      ...
      localStorage.setItem('trueed_teacher_banks', JSON.stringify([]));
    }
    ...
    if (savedTokens !== null) {
      ...
      localStorage.setItem('trueed_student_tokens', '5');
    }
