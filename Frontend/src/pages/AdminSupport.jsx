...
const mockTickets = [
  {
    id: 't1',
    user: { name: 'Priya Patel', type: 'student', initials: 'PP' },
    subject: 'Cannot access physics class recording',
    message: 'I missed the live session yesterday and when I click on the recording it says access denied. Can you please help?',
    date: '2023-10-15',
    status: 'OPEN',
    replies: []
  },
  {
    id: 't2',
    user: { name: 'Rahul Sharma', type: 'teacher', initials: 'RS' },
    subject: 'Issue with withdrawal',
    message: 'My withdrawal has been stuck in pending for 3 days now. Is there a problem with my bank details?',
    date: '2023-10-14',
    status: 'OPEN',
    replies: []
  },
  {
    id: 't3',
    user: { name: 'Akash Singh', type: 'student', initials: 'AS' },
    subject: 'Payment failed but money deducted',
    message: 'I tried to add ₹500 to my wallet using UPI, the transaction failed but the money was deducted from my account.',
    date: '2023-10-10',
    status: 'RESOLVED',
    replies: [
      { sender: 'Admin', text: 'Hi Akash, the transaction has been reversed by your bank. Please check your statement in 3-5 working days.' }
    ]
  }
];

export default function AdminSupport() {
  useEffect(() => { document.title = "Support — Admin Dashboard"; }, []);
