...
const CoachingCenters = () => {
  ...
  return (
    <div className="min-h-screen bg-cream/30 font-inter">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-navy to-navy-light text-white py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <span className="inline-block py-1 px-3 rounded-full bg-amber/20 text-amber font-bold text-xs mb-6 uppercase">New for Institutes</span>
          <h1 className="font-sora text-3xl md:text-5xl font-extrabold mb-6 leading-tight">
            Grow Your Coaching Center with True<span className="text-amber">Ed</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#apply" className="w-full sm:w-auto py-3 px-8 bg-amber text-navy rounded-xl font-bold hover:bg-amber-hover transition">
              Join Now
            </a>
            <a href="#how-it-works" className="w-full sm:w-auto py-3 px-8 bg-white/10 text-white border border-white/20 rounded-xl font-bold hover:bg-white/20 transition">
              Learn More
            </a>
          </div>
        </div>
      ...
      <section className="bg-white border-b border-slate-200 py-10 px-6">
        <div className="max-w-[1100px] mx-auto flex flex-wrap justify-around gap-8 text-center">
          <div>
            ...
            <div className="text-xs text-muted font-bold uppercase tracking-wide mt-1">Centers Onboarded</div>
          </div>
          <div>
            <div className="font-sora text-3xl font-extrabold text-navy">500+</div>
            <div className="text-xs text-muted font-bold uppercase tracking-wide mt-1">Students Placed</div>
          </div>
          <div>
            <div className="font-sora text-3xl font-extrabold text-navy">20+</div>
            <div className="text-xs text-muted font-bold uppercase tracking-wide mt-1">Cities Across India</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-[1100px] mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-sora text-2xl md:text-3xl font-bold text-navy mb-4">The Challenges You Face Today</h2>
          <p className="text-muted text-sm">Running a coaching center isn't easy without the right tools.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white p-8 rounded-brand shadow-brand border border-slate-100 text-center">
              <div className="w-16 h-16 bg-coral/10 text-coral rounded-full flex items-center justify-center text-2xl mx-auto mb-6">
      ...
      <section className="py-20 px-6 bg-navy text-white">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-sora text-2xl md:text-3xl font-bold text-white mb-4">Why Partner With Us?</h2>
            <p className="text-white/60 text-sm">Everything you need to modernize your coaching center.</p>
          </div>
      ...
      <section id="how-it-works" className="py-20 px-6 max-w-[1100px] mx-auto text-center">
        <h2 className="font-sora text-2xl md:text-3xl font-bold text-navy mb-16">How It Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          {[
            ...
            <div key={i} className="relative z-10">
              <div className="w-16 h-16 bg-navy text-white rounded-full flex items-center justify-center font-sora font-bold text-xl mx-auto mb-6 shadow-brand">
                {item.step}
              </div>
              <h3 className="font-sora font-bold text-navy mb-2 text-sm">{item.title}</h3>
              <p className="text-xs text-muted px-4">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-[#fff8e7]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-sora text-2xl font-bold text-navy mb-4">Transparent Pricing</h2>
          <p className="text-muted text-sm mb-8">We only make money when you do.</p>
          <div className="bg-white p-8 rounded-brand shadow-brand border border-amber/20 flex flex-col sm:flex-row items-center justify-around gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-navy text-sm">No upfront fees</span>
            </div>
            <div className="flex items-center gap-3">
              <i className="fa-solid fa-circle-check text-emerald-600 text-xl" />
              <span className="font-bold text-navy text-sm">No monthly charges</span>
            </div>
            <div className="flex items-center gap-3">
              <i className="fa-solid fa-percent text-amber text-xl" />
              <span className="font-bold text-navy text-sm">15% platform fee</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="apply" className="py-20 px-6">
        <div className="max-w-2xl mx-auto bg-white p-8 md:p-12 rounded-brand shadow-brand border border-slate-200">
          <div className="text-center mb-10">
            <h2 className="font-sora text-2xl md:text-3xl font-bold text-navy mb-3">Apply to Join</h2>
            <p className="text-muted text-sm">Fill out this quick form and our onboarding team will contact you within 24 hours.</p>
          </div>

          {submitted ? (
            <div className="bg-emerald-50 text-emerald-600 p-8 rounded-xl text-center border border-emerald-200 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold text-navy mb-2 uppercase">Center Name</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-navy mb-2 uppercase">Owner Name</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold text-navy mb-2 uppercase">Phone Number</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-navy mb-2 uppercase">City</label>
              ...
              <div>
                <label className="block text-xs font-bold text-navy mb-3 uppercase">Subjects Offered</label>
              ...
              <div>
                <label className="block text-xs font-bold text-navy mb-2 uppercase">Current Number of Students</label>
              ...
              <button type="submit" className="w-full py-3 bg-navy text-white rounded-xl font-bold hover:bg-navy-hover transition shadow-md">
                Submit Application
              </button>
            </form>
          )}
