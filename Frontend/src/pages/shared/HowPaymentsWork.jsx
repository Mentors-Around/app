...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border border-slate-200 rounded-lg bg-white overflow-hidden mb-3">
      ...
      >
        <span className="font-sora font-semibold text-navy text-sm">{question}</span>
      ...
      <div className={`transition-all duration-300 ease-in-out ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className="p-5 pt-0 text-muted text-xs border-t border-slate-100 mt-2 leading-relaxed">
          {answer}
        </div>
      </div>
    </div>
...
const HowPaymentsWork = () => {
  ...
  return (
    <div className="min-h-screen bg-cream/30 font-inter">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-navy to-sky/90 text-white py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-sora text-3xl md:text-5xl font-extrabold mb-6 leading-tight">
      ...
      <section className="py-20 px-6 max-w-[1100px] mx-auto text-center">
        <h2 className="font-sora text-2xl md:text-3xl font-bold text-navy mb-4">How TrueEd Escrow Works</h2>
        <p className="text-muted text-sm mb-16">A simple, transparent process to protect both students and teachers.</p>
        
        <div className="flex flex-col md:flex-row items-center justify-between relative max-w-4xl mx-auto gap-6 md:gap-4">
          <div className="hidden md:block absolute top-1/2 left-[15%] right-[15%] h-1 bg-slate-200 -z-10 -translate-y-1/2" />
          
          <div className="bg-white w-64 p-6 rounded-brand shadow-brand border border-slate-100 z-10 relative">
            <div className="w-14 h-14 bg-sky/10 text-sky rounded-full flex items-center justify-center text-2xl mx-auto mb-4">
              <i className="fa-solid fa-credit-card" />
            </div>
            <h3 className="font-sora font-bold text-navy text-sm mb-2">1. Student Pays</h3>
            <p className="text-xs text-muted">You book a class and pay securely through our platform.</p>
          </div>

          <div className="bg-navy w-64 p-6 rounded-brand shadow-brand-lg z-10 transform md:scale-110 relative text-white">
            ...
            <h3 className="font-sora font-bold text-white text-sm mb-2">2. TrueEd Holds</h3>
            <p className="text-xs text-white/70">Funds are locked securely in our escrow account.</p>
          </div>

          <div className="bg-white w-64 p-6 rounded-brand shadow-brand border border-slate-100 z-10 relative">
            <div className="w-14 h-14 bg-emerald-500/10 text-emerald-600 rounded-full flex items-center justify-center text-2xl mx-auto mb-4">
              <i className="fa-solid fa-hand-holding-dollar" />
            </div>
            <h3 className="font-sora font-bold text-navy text-sm mb-2">3. Teacher Gets Paid</h3>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-sora text-2xl md:text-3xl font-bold text-navy mb-6">Payment Release Rules</h2>
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-navy text-base">For Online Sessions</h3>
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-amber/10 text-amber-hover rounded-xl flex items-center justify-center flex-shrink-0 text-xl">
                  <i className="fa-solid fa-house-user" />
                </div>
                <div>
                  <h3 className="font-bold text-navy text-base">For Offline/Monthly Courses</h3>
                  <p className="text-xs text-muted mt-1 leading-relaxed">
              ...
              <div className="flex gap-4 pt-4 border-t border-slate-100">
                <div className="w-12 h-12 bg-coral/10 text-coral rounded-xl flex items-center justify-center flex-shrink-0 text-xl">
                  <i className="fa-solid fa-arrow-rotate-left" />
                </div>
                <div>
                  <h3 className="font-bold text-coral text-base">Refund Policy</h3>
                  <p className="text-xs text-muted mt-1 leading-relaxed">
          ...
          <div className="bg-slate-50 p-8 rounded-brand border border-slate-200">
            <h3 className="font-sora font-bold text-navy text-center mb-8 text-sm">Monthly Booking Timeline</h3>
            <div className="relative pt-6 pb-2">
              ...
              <div className="flex justify-between relative z-10">
                <div className="flex flex-col items-center w-1/3">
                  ...
                  <span className="font-bold text-navy text-xs">Day 1</span>
                  <span className="text-[9px] text-muted text-center mt-1">Student pays full amount</span>
                </div>
                <div className="flex flex-col items-center w-1/3">
                  <div className="w-5 h-5 bg-amber rounded-full border-4 border-white shadow-sm mb-3" />
                  <span className="font-bold text-navy text-xs">Day 15</span>
                  <span className="text-[9px] text-muted text-center mt-1">Teacher receives 40%</span>
                </div>
                <div className="flex flex-col items-center w-1/3">
                  <div className="w-5 h-5 bg-emerald-500 rounded-full border-4 border-white shadow-sm mb-3" />
                  <span className="font-bold text-navy text-xs">Course End</span>
                  <span className="text-[9px] text-muted text-center mt-1">Teacher receives 60%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 max-w-[1100px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-8 rounded-brand shadow-brand border-t-4 border-t-coral bg-white">
            <i className="fa-solid fa-calendar-xmark text-3xl text-coral mb-4" />
            <h3 className="font-bold text-navy text-sm mb-2">No Show, Full Refund</h3>
            <p className="text-xs text-muted">If the class doesn't happen due to the teacher, you get your money back instantly.</p>
          </div>
          <div className="bg-white p-8 rounded-brand shadow-brand border-t-4 border-t-sky bg-white">
            <i className="fa-solid fa-lock text-3xl text-sky mb-4" />
            <h3 className="font-bold text-navy text-sm mb-2">Secure Gateway</h3>
            <p className="text-xs text-muted">Bank-grade encryption ensures your card details and payments are always protected.</p>
          </div>
          <div className="bg-white p-8 rounded-brand shadow-brand border-t-4 border-t-amber bg-white">
            <i className="fa-solid fa-file-invoice-dollar text-3xl text-amber mb-4" />
            <h3 className="font-bold text-navy text-sm mb-2">No Hidden Charges</h3>
            <p className="text-xs text-muted">What you see is what you pay. We maintain 100% transparency on platform fees.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-sora text-2xl md:text-3xl font-bold text-navy mb-4 font-sora">Frequently Asked Questions</h2>
            <p className="text-muted text-sm">Everything you need to know about payments and refunds.</p>
          </div>
          <div>
            {faqs.map((faq, i) => (
