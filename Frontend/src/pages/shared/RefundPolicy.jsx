...
const RefundPolicy = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-12 md:py-20 font-inter">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="bg-white rounded-brand shadow-brand p-8 md:p-10 border border-slate-100">
          ...
          <div className="bg-sky/10 border border-sky/20 rounded-xl p-6 mb-10 flex gap-4">
            <Info className="w-6 h-6 text-sky flex-shrink-0 mt-0.5" />
            <div>
              <h4 className="font-bold text-navy mb-1 text-sm">Payment Protection Guarantee</h4>
          ...
          <div className="space-y-10">
            <section>
              <h2 className="font-sora font-bold text-lg text-navy flex items-center gap-2 mb-4">
            ...
            <section>
              <h2 className="font-sora font-bold text-lg text-navy flex items-center gap-2 mb-4">
                <span className="text-amber font-bold text-lg">⚠️</span> Non-Refundable Cases
              </h2>
              <div className="space-y-3 text-slate-600 font-medium leading-relaxed text-sm">
            ...
            <section>
              ...
              <div className="space-y-3 text-slate-600 font-medium leading-relaxed text-sm">
                ...
                <Link to="/contact" className="inline-block mt-2 text-sky font-bold hover:underline transition">
                  Contact Support →
                </Link>
              </div>
            </section>
