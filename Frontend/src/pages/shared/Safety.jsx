    ...
    <div>
      ...
      <div className="bg-navy text-white py-20 px-6 text-center">
        <div className="max-w-[800px] mx-auto">
          ...
          <h1 className="font-sora text-3xl md:text-5xl font-extrabold mb-4">Your Safety is Our Priority</h1>
          <p className="text-white/70 text-base md:text-lg">We build trust into every layer of TrueEd to ensure a secure learning environment for students and peace of mind for parents.</p>
        </div>
      </div>
      ...
      <div className="max-w-[1100px] mx-auto py-16 px-6 space-y-20">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-cream rounded-brand p-8">
            ...
            <a href="mailto:support@trueed.in" className="inline-flex py-2.5 px-5 bg-white border border-slate-200 text-error rounded-lg text-sm font-semibold hover:bg-error/5 transition items-center gap-2">
              <i className="fa-solid fa-flag" /> Report a Concern
            </a>
          </div>
          <div className="bg-cream rounded-brand p-8">
